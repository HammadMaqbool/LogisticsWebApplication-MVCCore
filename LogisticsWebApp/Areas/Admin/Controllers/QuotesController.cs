...
namespace LogisticsWebApp.Areas.Admin.Controllers
{
    ...
    public class QuotesController : Controller
    {
        ...
        {
            return View(await _context.tbl_Quote.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var quote = await _context.tbl_Quote
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var quote = await _context.tbl_Quote.FindAsync(id);
            if (quote == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Origin,Destination,Weight,Dimension,Name,Email,Phone,Message")] Quote quote)
        {
            if (id != quote.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (quote != null)
            {
                _context.tbl_Quote.Remove(quote);
            }
        ...
        {
            return _context.tbl_Quote.Any(e => e.Id == id);
        }
    }
}
